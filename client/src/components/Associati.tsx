  ...
  return (
    <section className="sezione-associazione">
      <div className="testo-associazione">
        <h2>Chi siamo</h2>
        <p>Siamo un'associazione culturale attiva sul territorio, impegnata nell'organizzazione di iniziative e attività per la comunità. Dal 2022, grazie a un bando comunale, gestiamo il servizio di aula studio, ma le nostre attività non si fermano lì.</p>
